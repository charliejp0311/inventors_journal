class InventionsController < ApplicationController
    ...
    def create
        @invention = Invention.new(invention_params(:title, :goal, :user_id, :description, :category_id, category_attributes:[:category]))
    ...
    private
    def invention_params(*args)
        params.require(:invention).permit(*args)
    end
    def problem_params
